    ...
    ZimBotInc.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                he = `Selamat Datang Di Group ${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
                let link = `https://chat.whatsapp.com/Dxtz9xAxial3A43AJetabYC`
let buttons = [
{buttonId: `halo`, buttonText: {displayText: 'WELCOME'}, type: 1}
]
let buttonMessage = {
document: fs.readFileSync('./storage/image/thumb.jpg'),
mimetype: feler,
...
title: `Jangan lupa tersenyum Wahai Anak Muda `,
body: `Moga Betah`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
...
headerType: 4,
contextInfo:{externalAdReply:{
title: `Selamat Tinggal Wahai Saudaraku, Terima kasih atas kunjungannya`,
body: `Tod 🗿`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
